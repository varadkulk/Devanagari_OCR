...
while x!=0:
    ...
    if x==0:
        ...
        while j<=0 or j>5:
            print("\nEnter:")
            print("1. for script output in terminal")
            ...
            if j<=0 or j>5:
                ...
                if j==1:
                    ...
                    text = input ("Enter outputfile: ")
                    f= open(text,"w+",encoding='utf-8')
                    f.write(pytesseract.image_to_string(img, lang=language))
                    f.close()
                elif j==3:
                    print(pytesseract.image_to_osd(img))#script info
                elif j==4:
